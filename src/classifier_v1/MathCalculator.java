...
public class MathCalculator {
	...
	public static double calcAvg(ArrayList<Module> inputModules) {
		int size = inputModules.size();
		double total = 0;
		for (int i=0; i< size; i++){
			total += inputModules.get(i).getOutput();
		}
		return (double) total / size;
	}

	public static double calcSD(ArrayList<Module> inputModules) {
		int size = inputModules.size();
		double mean = calcAvg(inputModules);
		double capSS = 0;
		for (int i = 0; i < size; i++) {
			capSS += (inputModules.get(i).getOutput() - mean) * (inputModules.get(i).getOutput() - mean);
		}
	...
	public static double calcMEDIAN(ArrayList<Module> inputModules) {
		int size = inputModules.size();
		double capMed;
		double[] temp = new double[size];
		for (int i = 0; i < size; i++) {
			temp[i] = inputModules.get(i).getOutput();
		}
	...
	public static double calcP25(ArrayList<Module> inputModules) {
		int size = inputModules.size();
		if (size<4)
			return calcMEDIAN(inputModules);
		double capP25;
		double[] temp = new double[size];
		for (int i = 0; i < size; i++) {
			temp[i] = inputModules.get(i).getOutput();
	...
	public static double calcP75(ArrayList<Module> inputModules) {
		int size = inputModules.size();
		if (size<4)
			return calcMEDIAN(inputModules);
		double capP75;
